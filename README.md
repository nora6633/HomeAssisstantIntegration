...
然而現在的智慧家庭系統通常是各自為政，缺乏一個統一的管理平台來整合不同品牌的智慧家電，而且這些系統在使用者體驗和互動性上仍有很多可以改進之處，因此我們決定開發一個基於 Home Assistant 平台的家庭自動化系統，目的是提供一個經濟實惠且功能強大的解決方案。

本專題研究的研究目標是開發一個可以整合多品牌智慧家電的系統，並可透過智慧語音助理來控制 Home Assistant 及各種家電。

在本文中，我們將介紹為什麼選擇 Raspberry Pi 4 作為硬體平台，以及 Home Assistant 作為系統核心的原因。我們希望這個系統能夠讓使用者以更直覺的方式控制家中的各類設備，提升智慧家庭的整
合性。

具體而言，本專題研究希望達到以下四個目標：
1.整合多品牌智慧家電：開發一個能夠支援多種智慧家電的系統，提升系統的整
合性和方便性，讓使用者能夠輕鬆管理各種不同品牌的設備。
2.提升使用者體驗：通過智慧語音助理，使用自然語言來控制家電，讓操作更直
觀、更簡單。
3.有效率的設備管理和監控：系統應該能夠即時監控各個設備的狀態，並提供自
動化設定和安全監控功能，確保家庭環境的安全和舒適。
